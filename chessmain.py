...
def main():
    ...
    p.display.set_caption('Vaibhav ka Chess')
    Icon = p.image.load('logo.jpeg')
            ...
            # ------ Mouse Clicked ----------------------------
                ...
                if not gameover and humanTurn:
                    ...
                    if len(playerClicks) == 1:
                        ...
                        elif not gs.whiteToMove and gs.board[int(playerClicks[0][0])][int(playerClicks[0][1])][
                            0] == 'w':
                            playerClicks = []
                            sqSelected = ()
                    ...
                    # -------------------------- 2nd Click -----------------------------------------
                        ...
                        if gs.board[int(playerClicks[0][0])][int(playerClicks[0][1])][0] == \
                                gs.board[int(playerClicks[1][0])][int(playerClicks[1][1])][0]:
